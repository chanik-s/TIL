...
SchedulingFlag stSchedulingInfo; //구조체 변수
...
void Driver_Stm_Init(void)
{
    ...
    g_Stm.stmConfig.ticks           = 100000u;//1ms
...
void STM_Int0Handler(void)
{
    ...
    IfxStm_increaseCompare(g_Stm.stmSfr, g_Stm.stmConfig.comparator, 100000u);//1ms

    u32nuCounter1ms++; //1ms에 1증가
