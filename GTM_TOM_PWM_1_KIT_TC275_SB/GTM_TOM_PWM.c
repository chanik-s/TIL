...
#define FADE_STEP           PWM_PERIOD / 500                     /* PWM duty cycle for the TOM                   */
...
void fadeLEDbyADC(unsigned int val)
{

    g_fadeValue =val;                           /* Calculation of the new duty cycle            */
    setDutyCycle(g_fadeValue);                                      /* Set the duty cycle of the PWM                */
}
void makeSound(unsigned int soundIdx){
    ...
    g_tomConfig.dutyCycle=(unsigned int)(uPeriod*0.08f);
