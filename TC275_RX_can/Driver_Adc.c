...
IfxVadc_Adc_Channel       adcChannel[ADC_GROUP0_MAX];
...
//    }
   ...
   // IfxVadc_enableServiceRequest(g_VadcAutoScan.adcGroup.group, IfxVadc_ChannelResult_4);//원래 4였
