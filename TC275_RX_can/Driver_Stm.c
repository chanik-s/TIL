...
void STM_Int0Handler(void)
{
    ...
    IfxStm_clearCompareFlag(g_Stm.stmSfr, g_Stm.stmConfig.comparator);//stm 0으로 세팅
    IfxStm_increaseCompare(g_Stm.stmSfr, g_Stm.stmConfig.comparator, 100000u); //1ms (100Mhz=10^8 1sec 기준)
